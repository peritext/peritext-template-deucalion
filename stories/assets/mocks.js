...
const webEdition = {
  data: {
    additionalHTML: '<link href="https://fonts.googleapis.com/css?family=Source+Serif+Pro:400,600,700" rel="stylesheet">',
    bibType: 'misc',
    citationLocale: {
    ...
    plan: {
      summary: [
        ...
        },
        {
          ...
          id: 'e90cf0e8-49bc-4e78-92c0-337d5ddd9601',
          type: 'events'
        }
      ],
      type: 'linear'
  ...
  id: 'd8211706-8732-4bc9-b936-eb5cc1ec331b',
  lastUpdateAt: 1556725807952,
  metadata: {
    templateId: 'deucalion',
    title: 'écran',
    type: 'screened'
  }
};
